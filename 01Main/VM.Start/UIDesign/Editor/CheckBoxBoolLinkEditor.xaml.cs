...
{
    [PropertyEditor(typeof(UICheckBox), "cb数据源")]
    public partial class CheckBoxBoolLinkEditor : UserControl
    {
        public CheckBoxBoolLinkEditor()
        {
        ...
        {
            ModuleDataSelectViewModel.Ins.GetData("bool");
