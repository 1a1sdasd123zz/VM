...
{
    //using EasyVision.Script.Method;
    ...
    public class ExpressionScriptSupport
    {
        ...
        public ExpressionScriptSupport(string _soutce)
        {
        ...
        public ExpressionScriptSupport()
        {
        ...
        public object CodeRun()
        {
            try
            {
                ...
                if (m_Compiled)
                {
                    object flag = this._objectClass.GetType().InvokeMember("Process", BindingFlags.InvokeMethod, null, this._objectClass, null);
                    return flag;
                }
            }
            catch (Exception /*e*/)
