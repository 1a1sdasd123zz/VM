...
{
    public class IsEnableControl : NotifyPropertyBase
    {
        #region 属性单例模式

        private static Lazy<IsEnableControl> Instance = new Lazy<IsEnableControl>(
            () => new IsEnableControl()
        );

        public IsEnableControl() { }

        public static IsEnableControl Ins { get; set; } = Instance.Value;
